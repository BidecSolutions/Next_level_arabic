...
import { fetchReadyPropertyList } from "@/lib/api/buy.server";
    ...
    {Array.isArray(area) &&
      community.map((com) => (
        <option key={com.id} value={com.id}>
         ...
         {!show &&  <div>
            <label className="block text-gray-600 mb-1">قائمة المجتمع</label>
            <select
              className="w-full border border-gray-300 rounded p-2"
...
console.log(developerId, "developerId", communityId, "community")
        ...
        // ✅ Call real API
        setIsLoading(true);
        const response = await fetchReadyPropertyList(params);
...
<PropertyImages property={property} />
                ...
                <div className="flex flex-col justify-between items-center  min-h-[175px] md:min-h-[80px] w-full p-[10px] pt-[0px]">
                  ...
                  <div className="text-gray-500 text-[11px] flex flex-col items-center mb-2 md:mb-4">
                    ...
                    <p className="text-[14px] text-center font-montserrat md:text-[18px] macbook:text[30px] font-bold text-[#8F8F8F]">
                      {property?.price}
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      navigate(`/ready-property/${property.slug}`);
                    }}
                  >
