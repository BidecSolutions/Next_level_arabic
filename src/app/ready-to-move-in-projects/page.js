...
import { Banner } from "@/components/WebsiteComponents/ReadyProjects/Banner";
import LatestProject from "@/components/WebsiteComponents/ReadyProjects/LatestProject";
...
const page = () => {
  ...
  return (
    <div>
      <Banner page={"Ready Projects"} />
      <div className="px-4 md:px-20">
        <LatestProject />

        {/* <MarketTransaction /> */}
        <HowToBuy howToBuyData={howToBuyData} pageName={"Ready Projects"} />
        <NewSection howToBuyData={howToBuyData} pageName={"Ready Projects"} />
        {/* <div className=" flex md:flex-row flex-col items-center py-2 md:justify-between macbook:justify-center ">
                    <Faqs page={7} />
                    <Inquiry page={`Ready Projects`} />
                </div> */}
        <PropertyList />
        <DeveloperSlider />
        <GetInTouch />
